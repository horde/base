...
<div>
 <?php printf(_("Login to Twitter and authorize %s"), $this->appname) ?>: <?php echo $this->link->link(['class' => 'horde-default', 'onclick' => Horde::popupJs($this->link, ['urlencode' => true]) . 'return false']) ?><?php echo _("Authorize") ?></a>
</div>
<?php endif; ?>
