...
<div class="hordeSmStreamstory">
  ...
  <div class="hordeSmStreambody">
    ...
    <?php endif; ?>
    <div class="hordeSmStreaminfo">
      <?php echo Horde::selfUrl()->link(['onclick' => 'Horde[\'twitter' . $this->instanceid . '\'].buildReply(\'' . (string) $this->tweet->id_str . '\', \'' . $this->tweet->user->screen_name . '\', \'' . $this->tweet->user->name . '\'); return false;']) . _("Reply") ?></a>
      &nbsp;|&nbsp; <?php echo Horde::selfUrl()->link(['onclick' => 'Horde[\'twitter' . $this->instanceid . '\'].retweet(\'' . (string) $this->tweet->id_str . '\'); return false;']) . _("Retweet") ?></a>
      <?php if (empty($this->tweet->favorited)): ?>
          &nbsp;|&nbsp; <?php echo Horde::selfUrl()->link(['id' => 'favorite' . $this->instanceid . $this->tweet->id_str, 'onclick' => 'Horde[\'twitter' . $this->instanceid . '\'].favorite(\'' . (string) $this->tweet->id_str . '\'); return false;']) . _("Favorite") ?></a>
      <?php else: ?>
         &nbsp;|&nbsp; <?php echo Horde::selfUrl()->link(['id' => 'favorite' . $this->instanceid . $this->tweet->id_str, 'onclick' => 'Horde[\'twitter' . $this->instanceid . '\'].unfavorite(\'' . (string) $this->tweet->id_str . '\'); return false;']) . _("Unfavorite") ?></a>
      <?php endif; ?>
    </div>
    <div class="clear">&nbsp;</div>
  </div>
