...
Upgrading Horde From 5.x To 6.x
===================================
...
An option has been added to always lowercase all user names after logging
in. The example in the 'authusername' hook that accomplished the same has been
removed.
...
shares have entries in ``doc/UPGRADING`` and upgrade scripts
