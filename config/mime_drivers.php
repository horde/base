 ...
 * Local overrides MUST be placed in var/config/horde/mime_drivers.local.php or
 * var/config/horde/mime_drivers.d/.
 * If the 'vhosts' setting has been enabled in Horde's configuration, you can
 * use var/config/horde/mime_drivers-servername.php.
 *
