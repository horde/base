 ...
 * Local overrides ONLY MUST be placed in var/config/horde/prefs.local.php or
 * var/config/horde/prefs.d/.
 * If the 'vhosts' setting has been enabled in Horde's configuration, you can
 * use var/config/horde/prefs-servername.php.
 *
...
$_prefs['time_format'] = [
    ...
    'type' => 'enum',
    'enum' => [
        'medium-time' => Format::formatDate(time(), 'medium-time', $GLOBALS['language'] ?? 'en_US') . ' (' . _("Default") . ')',
...
$_prefs['time_format_mini'] = [
    ...
    'type' => 'enum',
    'enum' => [
        'short-time' => Format::formatDate(time(), 'short-time', $GLOBALS['language'] ?? 'en_US') . ' (' . _("Default") . ')',
